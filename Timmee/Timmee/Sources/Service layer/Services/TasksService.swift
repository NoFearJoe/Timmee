...
protocol TaskEntitiesProvider: class {
    func fetchTaskEntity(id: String) -> TaskEntity?
}

protocol TaskEntitiesBackgroundProvider: class {
...
protocol TasksObserverProvider: class {
    func tasksObserver(predicate: NSPredicate?) -> CoreDataObserver<Task>
}

protocol TaskEntitiesCountProvider: class {
    func tasksCount() -> Int
...
final class TasksService {
    ...
    init(listsProvider: ListEntitiesProvider,
...
extension TasksService: TasksManager {
    ...
    func updateTasks(_ tasks: [Task], completion: @escaping (Error?) -> Void) {
...
extension TasksService: TaskEntitiesBackgroundProvider {
    ...
    func fetchTaskEntitiesInBackground(tasks: [Task]) -> [TaskEntity] {
        return TasksService.taskEntitiesFetchRequest(tasks: tasks)
    }
