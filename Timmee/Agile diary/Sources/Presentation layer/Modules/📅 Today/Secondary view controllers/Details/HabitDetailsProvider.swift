...
final class HabitDetailsProvider: DetailModuleProvider, SprintInteractorTrait {
    ...
    func reloadContent() {
        ...
        if let dueTime = habit.dueTime {
            ...
            dueTimeLabel.font = AppTheme.current.fonts.regular(24)
            dueTimeLabel.textColor = AppTheme.current.colors.activeElementColor
            dueTimeLabel.text = dueTime.string
            let dueTimeContainer = DetailView(title: "due_time".localized, detailView: dueTimeLabel)
            dueTimeContainer.titleLabel.font = AppTheme.current.fonts.regular(14)
            dueTimeContainer.titleLabel.textColor = AppTheme.current.colors.inactiveElementColor
            contentView.addView(dueTimeContainer)
        }
        
        // reminder
        if habit.notification != .none {
            ...
            reminderLabel.text = habit.notification.readableString
        ...
        // link
        if !habit.description.trimmed.isEmpty {
            ...
            descriptionLabel.font = AppTheme.current.fonts.regular(16)
            ...
            let descriptionContainer = DetailView(title: "description".localized, detailView: descriptionLabel)
            descriptionContainer.titleLabel.font = AppTheme.current.fonts.regular(14)
            descriptionContainer.titleLabel.textColor = AppTheme.current.colors.inactiveElementColor
            contentView.addView(descriptionContainer)
        }
